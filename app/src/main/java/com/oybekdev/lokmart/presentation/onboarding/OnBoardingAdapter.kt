...
import com.oybekdev.lokmart.databinding.ItemOnboardingBinding
...
class OnBoardingAdapter:RecyclerView.Adapter<OnBoardingAdapter.ViewHolder>() {
    ...
    companion object{
        private val items = listOf(
            Triple(R.drawable.onboarding_image_0,R.string.onboarding_title_0,R.string.onboarding_description),
            Triple(R.drawable.onboarding_image_1,R.string.onboarding_title_0,R.string.onboarding_description)
        )
    }
}