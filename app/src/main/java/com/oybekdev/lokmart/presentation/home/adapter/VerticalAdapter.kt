...
import com.oybekdev.lokmart.databinding.ItemProductVerticalSectionBinding
...
class VerticalAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =  ViewHolder (
        ItemProductVerticalSectionBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    )
